...
//		else if((Input.GetKeyUp (KeyCode.A) || Input.GetKeyUp (KeyCode.D)))
  ...
  public int godmodeDamage = 50;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            GlobalValue.checkpointNumber = collision.gameObject.GetComponent<CheckpointNumber>().checkpointIndex;
            GlobalValue.lastOrNewLevel = 3;
            ...
            PlayerPrefs.SetInt("LastCheckPoint", collision.gameObject.GetComponent<CheckpointNumber>().checkpointIndex);
