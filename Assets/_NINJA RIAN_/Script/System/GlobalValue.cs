...
{
    public static int hasKeyForSecondLevel
    {
        get { return PlayerPrefs.GetInt("hasKeyForSecondLevel", 0); }
        set { PlayerPrefs.SetInt("hasKeyForSecondLevel", value); }
    }
    public static int platformControllerSwitcher
    {
        get { return PlayerPrefs.GetInt("platformControllerSwitcher", 0); }
        set { PlayerPrefs.SetInt("platformControllerSwitcher", value); }
    }
    public static int lastOrNewLevel
    {
        get { return PlayerPrefs.GetInt("lastOrNewLevel", 1); }
        set { PlayerPrefs.SetInt("lastOrNewLevel", value); }
    }
    public static int checkpointNumber
    {
        get { return PlayerPrefs.GetInt("checkpointNumber", 0); }
        set { PlayerPrefs.SetInt("checkpointNumber", value); }
    }
    /// <summary>
    /// Freelance ( in top )
    /// </summary>
